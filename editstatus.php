            ...
            <ul class="metismenu" id="menu">
              ...
              <li>
                ...
                <ul class="collapse">
                  ...
                  <li class="active"><a href="editstatus.php"> Status</a></li>
                </ul>
              </li>
                    ...
                    <div class="table-responsive">
                      ...
                      <div class="container1">
                        ...
                        <body>
                          ...
                          <head>
                            <title>Status Management Table</title>
                          </head>
                          ...
                          <body>
                            <div class="container">
                                ...
                                <table>
                                  ...
                                  <?php while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                      ...
                                      <td>
                                        <a href="editstatus.php?delete=<?php echo $row['id']; ?>"
                                          onclick="return confirm('Are you sure you want to delete this item?')">Delete</a>
                                        <a href="editconfig_status.php?id=<?php echo $row['id']; ?>">Edit</a>
                                      </td>
                                    </tr>
                                  <?php } ?>
                                </table>
                              ...
                              <div class="result-container">
                                <h2>Add New Record to 'Status'</h2>
