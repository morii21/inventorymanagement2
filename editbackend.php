            ...
            <ul class="metismenu" id="menu">
              ...
              <li>
                ...
                <ul class="collapse">
                  ...
                  <li  class="active"><a href="editbackend.php"> Backend</a></li>
                    ...
                    <div class="table-responsive">
                      ...
                      <div class="container1">
                        ...
                        <body>
                          ...
                          if (isset($_POST['add'])) {
                            $name = $_POST['name'];
                            $sql = "INSERT INTO backend (name) VALUES ('$name')";
                          ...
                          if (isset($_GET['delete'])) {
                            $id = $_GET['delete'];
                            $sql = "DELETE FROM backend WHERE id=$id";
                          ...
                          if (isset($_POST['edit'])) {
                            $id = $_POST['id'];
                            $name = $_POST['name'];
                            $sql = "UPDATE backend SET name='$name' WHERE id=$id";
                            mysqli_query($conn, $sql);
                          }
                          ...
                          <head>
                            <title>Backend Management Table</title>
                          </head>
                          ...
                          <body>
                            <div class="container">
                                ...
                                <table>
                                  ...
                                  <?php while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                      ...
                                      <td>
                                        <a href="editbackend.php?delete=<?php echo $row['id']; ?>"
                                          onclick="return confirm('Are you sure you want to delete this item?')">Delete</a>
                                        <a href="editconfig_back.php?id=<?php echo $row['id']; ?>">Edit</a>
                                      </td>
                                    </tr>
                                  <?php } ?>
                                </table>
                              ...
                              <div class="result-container">
                                <h2>Add New Record to 'Backend'</h2>
